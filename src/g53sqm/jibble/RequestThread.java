...
//          HashMap headers = new HashMap();
            ...
            if (file.getParent().indexOf("cgi-bin") >= 0) {
                try {
                    ...
                    out.flush();
                    Login.log(ip, path, 200);
                }
                catch (Throwable t) {
                    // Internal server error!
                    Login.log(ip, request, 500);
            ...
            Login.log(ip, "ERROR " + e.toString() + " " + request, 0);
            if (reader != null) {
                try {
                    reader.close();
                }
